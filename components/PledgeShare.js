            ...
            <div className="card share-card border-0 p-3">
              <div className="card-body">
                ...
                <div className="d-flex flex-column flex-md-row justify-content-evenly">
                  ...
                  <a target="_blank" className="btn btn-social btn-tw flex-grow-1 m-2" href={`https://twitter.com/intent/tweet?url=https%3A%2F%2Fact.globalhumanrights.org%2F${slug}`}>
