            ...
            <div className="card share-card p-3">
              <div className="card-body">
                ...
                <div className="d-flex flex-column flex-md-row justify-content-evenly">
                  <a target="_blank" className="btn btn-social btn-fb flex-grow-1 m-2" href={`https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fact.globalhumanrights.org%2F${slug}`}>
                  ...
                  <a target="_blank" className="btn btn-social btn-li flex-grow-1 m-2" href={`https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fact.globalhumanrights.org%2F${slug}`}>
                  ...
                  <a target="_blank" className="btn btn-social btn-wa flex-grow-1 m-2" href={`https://api.whatsapp.com/send?text=https%3A%2F%2Fact.globalhumanrights.org%2F${slug}`}>
